#ifndef HEADER_943E9782_34CD_481A_B6DA_1AB72516A203_INCLUDED
#define HEADER_943E9782_34CD_481A_B6DA_1AB72516A203_INCLUDED

/*
  Original code for Munkres' Assignment Algorithm from:
  https://sites.google.com/site/kareemergawy/

  Slightly tweaked by me by renaming the `runMunkers` function, changing
  references to pointers, and operator new to malloc. The original author's
  coding style is otherwise left intact.
*/
...
int** getFilterMatrix(int** matrix, int n, bool max) {
  ...
  bool done = false;
  int step = 1;
  int* rowCover = (int*)malloc(sizeof(int) * n);
  int* colCover = (int*)malloc(sizeof(int) * n);
